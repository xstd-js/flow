...
import { AsyncFlowFactoryCollection } from '../../factory/async-flow-factory-collection.js';
...
export class WebSocketFlow extends AsyncFlowFactoryCollection<WebSocketFlowItems> {
